...
const LandingPage = () => {
    return (
        <div className="landing-page">
            ...
            <section className="container" style={{ padding: '4rem 1.5rem 1rem 1.5rem', textAlign: 'center' }}>
            ...
            <section className="container" style={{ padding: '1rem 1.5rem 4rem 1.5rem', backgroundColor: 'var(--color-bg-secondary)', borderRadius: '1rem' }}>
